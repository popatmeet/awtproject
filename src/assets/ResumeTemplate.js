...
function ResumeTemplate({generateNew}) {
	...
	const skills = [
		...
		{skill: 'Python', icon: 'fa-react'},
		{skill: 'JAVA', icon: 'fa-react'},
		{skill: 'Security and Networking', icon: 'fa-react'},
		{skill: 'Machine Learning', icon: 'fa-react'},
    ];
    const hobbies = [
		...
		{hobby: 'Cricket', icon: 'fa-tree'},
		{hobby: 'Traveling', icon: 'fa-tree'},
    ];
