...
function ResumeInputForm() {
    ...
    const skills = ['HTML', 'CSS', 'Java Script', 'React.JS', 'Python', 'JAVA', 'Security and Networking', 'Machine Learning'];
  
    const hobbies = ['Reading', 'Music', 'Gaming', 'Gardening', 'Cricket', 'Traveling']
    ...
    const contactFields = () => {
        return (
            <>
                <div className="form-group">
                    <input type="tel" value={phone}onChange={(e) => {setPhone(e.target.value)}} name="telephone" id="phone" placeholder="Phone Number" required />
                    <span style={{color: 'red', alignSelf: 'baseline'}}>*</span>
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                    <input type="text" value={website} onChange={(e) => {setWebsite(e.target.value)}} name="website" id="website" placeholder="Website" />
                </div>
                <div className="form-group">
